...
export default function CreatePost() {
    ...
    // fire dispatch (useDispatch) =>  store to recived data => reducer => UI
                ...
                {!editingPost && (
                    <Fragment>
                         <button
                            ...
                            type='submit'>
                            <span className='relative rounded-md bg-green-500 p-2 px-5 py-2.5 transition-all duration-75 ease-in group-hover:bg-opacity-0 dark:bg-gray-900'>
                                Publish Post
                            </span>
                        </button>
                    </Fragment>
                ...
                {editingPost && (
                    <Fragment>
                         <button
                            ...
                            <span className='relative rounded-md bg-orange-600 px-5 py-2.5 transition-all duration-75 ease-in group-hover:bg-opacity-0 dark:bg-gray-900'>
                                Update Post
                            </span>
                        </button>
                        <button
                            ...
                            >
                            <span className='relative rounded-md bg-indigo-500 px-5 py-2.5 transition-all duration-75 ease-in group-hover:bg-opacity-0 dark:bg-gray-900'>
                                Cancel
                            </span>
                        </button> 
                    </Fragment>
